class AlarmDB:
    ...
    def init_alarm_db(self):
        alarm_dict = {
            'KLAMPO251': {'Val': 0, 'Em':False, 'Des': 'Intermediate range high flux rod stop'},
            'KLAMPO252': {'Val': 0, 'Em':False, 'Des': 'Power range overpower rod stop'},
            'KLAMPO253': {'Val': 0, 'Em':False, 'Des': 'Control bank D full rod withdrawl'},
            'KLAMPO254': {'Val': 0, 'Em':False, 'Des': 'Control bank lo-lo limit'},
            ...
            'KLAMPO321': {'Val': 0, 'Em':True, 'Des': 'RCP 1,2,3 trip'},
            ...
            'KLAMPO332': {'Val': 0, 'Em':True, 'Des': 'FW pump trip'},
            ...
            'KLAMPO337': {'Val': 0, 'Em':True, 'Des': 'TBN trip P-4'},
            'KLAMPO338': {'Val': 0, 'Em':True, 'Des': 'SG 1,2,3 wtr level hi-hi TBN trip'},
            'KLAMPO339': {'Val': 0, 'Em':True, 'Des': 'Condenser vacuum lo TBN trip'},
            'KLAMPO340': {'Val': 0, 'Em':True, 'Des': 'TBN overspeed hi TBN trip'},
            'KLAMPO341': {'Val': 0, 'Em':True, 'Des': 'Gen. brk open'},
            'KLAMPO341': {'Val': 0, 'Em':True, 'Des': 'Gen. brk open'},
