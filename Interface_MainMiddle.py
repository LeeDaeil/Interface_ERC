...
class MainMiddle(ABCWidget):
    def __init__(self, parent, widget_name=''):
        ...
        self.shortcut_move_item_down = QShortcut(Qt.Key.Key_Down, self, lambda: self.inmem.widget_ids['MainMiddleMimicScene'].move_item('down'))
...
class MainMiddleMimicScene(ABCGraphicsScene):
    ...
    def load_scene(self):
        ...
        # load json file
        with open('./Interface_MainMiddle_Mimic.json', encoding='UTF8') as f:
...
class Indicator(ABCGraphicsRectItem):
    ...
    def paint(self, painter: QPainter, option: 'QStyleOptionGraphicsItem', widget) -> None:
        val = self.inmem.ShMem.get_para_val(self.ParaName)
